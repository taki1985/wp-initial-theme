...
<li class="news-list__item">
  ...
  ?>
    ...
    ?>
      <a href="<?php echo $permalink; ?>" class="news-list__content<?php if ($is_pdf) echo ' icon-pdf'; ?><?php if ($is_external) echo ' icon-external'; ?>" <?php if ($is_external || $is_pdf) echo 'target="_blank"'; ?>>

      <?php else : //通常の投稿
      ?>
        <a href="<?php the_permalink() ?>" class="news-list__content">
        <?php endif; ?>
        ...
        <div class="news-list__main">
          <div class="news-list__meta">
            ...
            if ($days > $keika) :
              echo '<div class="news-list__new">New</div>';
            endif;
            ?>
            <div class="news-list__time"><?php the_time('Y.m.d'); ?></div>
