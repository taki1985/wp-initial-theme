...
add_action('admin_bar_menu', 'remove_bar_menus', 99);
...
{
	// add_menu_page_by_slug('text', 'text', 'manage_options', 'slug', '', 'dashicons-calendar-alt', 8);
}
...
add_action('admin_head', 'add_favicon_dashboard');
add_action('login_head', 'add_favicon_dashboard');
