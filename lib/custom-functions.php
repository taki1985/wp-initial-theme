...
*サムネイル画像取得
*/
function get_thumbs($id, $use_content = true, $size = 'thumbnail')
{
...
*WebP用画像タグ出力
*/
function original_get_img_tag($src, $alt = "", $class = "", $use_size = true)
{
...
function is_ancestor($slug)
{
  ...
  $result = false;
  if (isset($page) && property_exists("post", "ancestors")) {
